...
return array(
	...
	'updateFields' => "array('goods_id','goods_name','cat_id','brand_id','market_price','shop_price','jifen','jyz','jifen_price','is_promote','promote_price','promote_start_time','promote_end_time','is_hot','is_new','is_best','is_on_sale','seo_keyword','seo_description','type_id','sort_num','is_delete','goods_desc')",
	'validate' => "
	...
	'search' => array(
		...
		array('is_on_sale', 'in', '1-上架,0-下架', '', '是否上架：1：上架，0：下架'),
